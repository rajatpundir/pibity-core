...
@Entity
@Table(name = "mapping_space_function_permissions", schema = ApplicationConstants.SCHEMA)
data class SpaceFunctionPermission(

  @EmbeddedId
  val id: SpaceFunctionPermissionId,
  ...
  override fun equals(other: Any?): Boolean {
    ...
    other as SpaceFunctionPermission
