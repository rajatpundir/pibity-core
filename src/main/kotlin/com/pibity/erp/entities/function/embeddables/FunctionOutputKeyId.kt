...
@Embeddable
data class FunctionOutputKeyId(
    ...
    @JoinColumns(*[JoinColumn(name = "function_organization_id", referencedColumnName = "function_organization_id"),
      ...
      JoinColumn(name = "function_output_name", referencedColumnName = "function_output_name"),
  ...
  override fun equals(other: Any?): Boolean {
    ...
    other as FunctionOutputKeyId
    return this.functionOutputType == other.functionOutputType && this.key == other.key
  }

  override fun hashCode(): Int = Objects.hash(functionOutputType, key)
}
