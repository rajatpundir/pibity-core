...
class VariableService(
  ...
  fun createVariable(jsonParams: JsonObject, variableOrganization: Organization? = null, variableType: Type? = null, variableSuperList: VariableList? = null): Variable {
    ...
    val variable = Variable(id = VariableId(superList = superList, type = type, name = if (type.id.superTypeName == "Any" && type.autoAssignId) (type.autoIncrementId + 1).toString() else variableName), autoGeneratedId = type.autoIncrementId + 1, subList = if (type.id.superTypeName == "Any") variableListRepository.save(VariableList(listType = organization.superList!!.listType)) else null)
